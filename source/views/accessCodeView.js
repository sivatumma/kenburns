enyo.kind({
    ...
    components: [{
        ...
        components: [{
            ...
            components: [{
                tag: "img",
                attributes: [{
                    src: "assets/internetOfThings.png"
                }]
            }]
        }, {
            id: "accessCodeForm",
            components: [{
                ...
                content: "Enter your Access Code to Begin",
                classes: "content"
            }, {
                kind: "Input",
                name: "accessCodeInput",
                classes: "accessCodeInput",
                //onkeyup:"checkSecureId"
            }, {
            ...
            components: [{
                ...
                classes: "content",
                content: "Introducing Cisco's Exclusive Smart City Chicago app."
            }, {
                classes: "content",
                content: "Explore the magic of Cisco Smart City Technologies in the city of Chicago."
            }]
        }, {
            classes: "footerLogo",
            components: [{
    ...
    checkSecureId: function(inSender, inEvent) {
        if (this.$.accessCodeInput.value && (this.$.accessCodeInput.value.toLowerCase() == AppConfig.secureid.toLowerCase())) {
            if (this.$.termsCheckbox.checked) {
                // store that the user has entered th code
                localStorage.setItem("secureId", AppConfig.secureid)
                enyo.Signals.send("showLoginScreen", {});
            } else {
                this.$.alertMessage.setContent("Please Accept Terms of Use");
            }
        } else {
            this.$.alertMessage.setContent("Please Enter Valid Secure Code");
        }
    },
