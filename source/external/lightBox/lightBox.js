...
enyo.kind({
	...
	*/
	...
	create: function() {
		...
		this.$.close.setSrc("assets/close_button.png");
	},
	updatePosition: function() {
		...
		this.$.client.applyStyle("width", w-50 + "px");
		this.$.client.applyStyle("height", h-50 + "px");
	},
	...
	statics: {
		...
		*/
		...
		//closeBtnURI: "https://173.36.245.244/Mobile/assets/close_button.png",
		// closeBtnURI: "http://localhost:8080/workspace/w2/CLS-Mobile-App/assets/close_button.png",
		//* @public
		/**
